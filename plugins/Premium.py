...
async def premium_user(client, message):
    ...
    # 👈 FIXED: Query directly from premium collection (db.users)
    now_utc = datetime.datetime.now(datetime.timezone.utc)
    cursor = db.users.find({"expiry_time": {"$gt": now_utc}})
